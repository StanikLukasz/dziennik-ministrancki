...
def oblicz_bilans_punktow(db=None, ministrant_id=None):
    obecnosci_wszystkie = db.obecnosci.count_documents({})
    print(obecnosci_wszystkie)
    ...
    print( PUNKTY_ZA_OBOWIAZKOWA*obecnosci_obowiazkowe + PUNKTY_ZA_NIEOBOWIAZKOWA*(obecnosci_wszystkie-obecnosci_obowiazkowe))
